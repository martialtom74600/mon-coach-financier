...
const PurchaseRecap = dynamic(
  () => import('@/app/components/simulator/PurchaseRecap').then((m) => ({ default: m.PurchaseRecap })),
  { ssr: false, loading: () => <PageLoader variant="compact" /> },
);

const DiagnosticCard = dynamic(
  () => import('@/app/components/simulator/DiagnosticCard').then((m) => ({ default: m.DiagnosticCard })),
  { ssr: false, loading: () => <PageLoader variant="compact" /> },
);
